...
<table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  <tr>
	<td nowrap width="25%" style="BORDER-RIGHT: 1px solid; PADDING-RIGHT: 1px; PADDING-LEFT: 1px; PADDING-BOTTOM: 1px; BORDER-LEFT: 1px solid; PADDING-TOP: 1px"    bordercolor="#000000" height="14" align="left" valign="top">
		<a name="topo">
		<IMG height=52 src="../img/SLIDE27A.jpg" width=50 border=0 ></a><b><font size="2"><span lang="pt-br">Alterar Informações cadastrais - Pessoa 
...
<img src='../img/PDCalendario.gif' align='middle' onclick="return showCalendar('ClienteDesde', 'dd/mm/y');Valida_data(ClienteDesde,ClienteDesde,'Atual','','','')" WIDTH='16' HEIGHT='16'></a> </td>
 ...
 <table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="100%" id="AutoNumber1"> 
  <tr>
    ...
    <b><font size="1" face="Arial">&nbsp; Órgão</td>
    ...
    <b><font face="Arial" size="1">&nbsp;Inscrição estadual</font></b></td>
    <td class=td_borda1 width="172"><b><font face="Arial" size="1">&nbsp;Inscrição municipal</font></b></td>  
  </tr>
  <tr>
    ...
    <td nowrap width="26%" class=td_borda>
    	<b><font size="1" face="Arial">&nbsp;</font></b>
    	<input type=text id=orgaoExpedidor name=orgaoExpedidor title="Opcional - Informe em qual órgão a empresa foi registrada" size="31">&nbsp;</td>
    	<td class=td_borda>
    ...
    <td nowrap width="14%" class=td_borda>
    	<b><font size="1" face="Arial">&nbsp;</font></b><input type=text id=InscricaoEstadual name=InscricaoEstadual title="Opcional - Informe o número da inscrição estadual da empresa">
    </td>
    <td class=td_borda><input type=text id=inscricaoMunicipal name=inscricaoMunicipal title="Opcional - Informe o número da inscrição municipal da empresa"></td>
  </tr> 
 </table>
<table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  <tr>
    <td nowrap width="36%" bgcolor="#DE9E9E" style="padding: 1px" bordercolor="#000000" height="14" align="left" valign="top">
    <b><font size="1" face="Arial">01.1 CONFIGURAÇÕES</font></b></td>
  </tr>
 </table>
...
<table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  <tr>
    ...
    <b><font face="Arial" size="1">Forma jurídica</font></b></td>
    ...
    <b><font face="Arial" size="1">Porte</font></b></td>
     ...
     <td class=td_borda1 width="188"><b><font face="Arial" size="1">&nbsp;Situação junta à Receita Federal</font></b></td>  
  ...
  <tr>
    ...
    <td nowrap width="28%" class=td_borda>
		<input type=text  id=capitalRealizado name=capitalRealizado value="0.00" title="Opcional - Informe o valor do capital realizado no exercício">
		<b><font size="1" face="Arial">&nbsp;Exercício:</font></b>
		<input type=text  id=exercicioCapitalRealizado name=exercicioCapitalRealizado title="Opcional - Informe o execício referente ao capital realizado" size="12">
		<a name="topo41"><img src='../img/PDCalendario.gif' align='middle' onclick="return showCalendar('exercicioCapitalRealizado', 'dd/mm/y');Valida_data(exercicioCapitalRealizado,exercicioCapitalRealizado,'Atual','<','DataConstituicao','Data da constituição')" WIDTH='16' HEIGHT='16'></a></td>
...
<table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
 ...
 <table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  ...
  <tr>
    ...
    <td nowrap width="1%" class=td_borda>
    	<b><font size="1" face="Arial">&nbsp;</font></b><input type=text id=nomeSite name=nomeSite title="Opcional - Informe o endereço do Site da empresa na Internet" size="65">
    </td>
   </tr> 
</table>
<table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
...
<table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="100%" id="AutoNumber1">
  <tr>
    <td nowrap width="5%" class=td_borda1>
    <b><font size="2" face="Arial" color= #0000FF>Endereço para correspondência( Tipo 
  ...
  <tr>
    <td nowrap width="1%" class=td_borda>
    	...
    	<input type=text id=NomeLogradouroFil name=NomeLogradouroFil title='Opcional - Informe o logradouro, número e complemento' onClick="checkList(this,logradouros)" onKeyUp="checkList(this,logradouros)" size="55">
	   ...
	   <input type=text id=PerimetroFil name=PerimetroFil title="Opcional - Informe o perímetro para facilitar a localização quando endereço Rural" size="38">
...
<table border="0" cellpadding="0" cellspacing="0" style="BORDER-COLLAPSE: collapse" bordercolor="#111111" width="100%" id="AutoNumber1" height="116">
  ...
  <tr>
    ...
    <td nowrap width="10%" class=td_borda1>
        <b><font size="1" face="Arial"></font></b>
        <input type=text id=IdentificacaoFiscalCtr1 name=IdentificacaoFiscalCtr1 title="Opcional - Informe a Identificação fiscal do controlador" size="17">
    </td>
    <!--td nowrap width="7%" class=td_borda1>
        <b><font size="1" face="Arial"></font></b>
        <input type=text id=Nacionalidade1 name=Nacionalidade1 title="Opcional - Informe a nacionalidade quando o controlador é pessoa física"  size="12">
	 </td-->
	<td nowrap width="9%" class=td_borda>
        <b><font size="1" face="Arial"></font></b>
        <input type=text id=vinculadoEmCtr1 name=vinculadoEmCtr1 title="Opcional - Informe a data em que se oficializou o vínculo" size="11">
        <a name="topo41">
<img src='../img/PDCalendario.gif' align='middle' onclick="return showCalendar('vinculadoEmCtr1', 'dd/mm/y');Valida_data(vinculadoEmCtr1,vinculadoEmCtr1,'Atual','<','DataConstituicao','Data anterior à da constituição')" WIDTH='16' HEIGHT='16'></a>
	 </td>
    <td nowrap width="16%" class=td_borda>
    	<b><font size="1" face="Arial"></font></b>
    	<input type=text id=qtdCotCtr1 name=qtdCotCtr1 value=0 title="Opcional - Informe a quantidade de cotas" size="6"><input type=text id=valorCotCtr1 name=valorCotCtr1 value="0.00" title="Opcional - Informe o valor unitário da cota">
    </td> 
    <td nowrap width="9%" class=td_borda>
    	<b><font size="1" face="Arial"></font></b>
    	<input type=text id=percCapVotanteCtr1 name=percCapVotanteCtr1 value="0.00" title="Opcional - Informe o percentual sobre o capital votante referente ao controlador em questão" size="7">
    </td>  
  </tr>
  <tr>
    <td nowrap width="48%" class=td_borda1>
    ...
    <td nowrap width="10%" class=td_borda1>
        <b><font size="1" face="Arial"></font></b>
		<input type=text id=IdentificacaoFiscalCtr2 name=IdentificacaoFiscalCtr2 title="Opcional - Informe a Identificação fiscal do controlador" size="17">
    </td>
    <!--td nowrap width="7%" class=td_borda1>
        <b><font size="1" face="Arial"></font></b>
        <input type=text id=Nacionalidade2 name=Nacionalidade2 title="Opcional - Informe a nacionalidade quando o controlador é pessoa física" size="12">
	 </td-->
	<td nowrap width="9%" class=td_borda>
        <b><font size="1" face="Arial"></font></b>
        <input type=text id=vinculadoEmCtr2 name=vinculadoEmCtr2 title="Opcional - Informe a data em que se oficializou o vínculo" size="11">
        <a name="topo42">
<img src='../img/PDCalendario.gif' align='middle' onclick="return showCalendar('vinculadoEmCtr2', 'dd/mm/y');Valida_data(vinculadoEmCtr2,vinculadoEmCtr2,'Atual','<','DataConstituicao','Data anterior à da constituição')" WIDTH='16' HEIGHT='16'></a></td>
    <td nowrap width="16%" class=td_borda>
    	<b><font size="1" face="Arial"></font></b>
    	<input type=text id=qtdCotCtr2 name=qtdCotCtr2 value=0 title="Opcional - Informe a quantidade de cotas" size="6"><input type=text id=valorCotCtr2 name=valorCotCtr2 value="0.00" title="Opcional - Informe o valor unitário da cota">
    </td> 
    <td nowrap width="9%" class=td_borda>
    	<b><font size="1" face="Arial"></font></b>
    	<input type=text id=percCapVotanteCtr2 name=percCapVotanteCtr2 value="0.00" title="Opcional - Informe o percentual sobre o capital votante referente ao controlador em questão" size="7">
    </td>    
  </tr>
  <tr>
    <td nowrap width="48%" class=td_borda1>
    ...
    <td nowrap width="10%" class=td_borda1>
        <b><font size="1" face="Arial"></font></b>
		<input type=text id=IdentificacaoFiscalCtr3 name=IdentificacaoFiscalCtr3 title="Opcional - Informe a Identificação fiscal do controlador" size="17">
    </td>
    <!--td nowrap width="7%" class=td_borda1>
        <b><font size="1" face="Arial"></font></b>
        <input type=text id=Nacionalidade3 name=Nacionalidade3 title="Opcional - Informe a nacionalidade quando o controlador é pessoa física" size="12">
	 </td-->
	<td nowrap width="9%" class=td_borda>
        <b><font size="1" face="Arial"></font></b>
        <input type=text id=vinculadoEmCtr3 name=vinculadoEmCtr3 title="Opcional - Informe a data em que se oficializou o vínculo" size="11">
        <a name="topo43">
<img src='../img/PDCalendario.gif' align='middle' onclick="return showCalendar('vinculadoEmCtr3', 'dd/mm/y');Valida_data(vinculadoEmCtr3,vinculadoEmCtr3,'Atual','<','DataConstituicao','Data anterior à da constituição')" WIDTH='16' HEIGHT='16'></a></td>
    <td nowrap width="16%" class=td_borda>
    	<b><font size="1" face="Arial"></font></b>
    	<input type=text id=qtdCotCtr3 name=qtdCotCtr3 value=0 title="Opcional - Informe a quantidade de cotas" size="6"><input type=text id=valorCotCtr3 name=valorCotCtr3 value="0.00" title="Opcional - Informe o valor unitário da cota">
    </td> 
    <td nowrap width="9%" class=td_borda>
    	<b><font size="1" face="Arial"></font></b>
    	<input type=text id=percCapVotanteCtr3 name=percCapVotanteCtr3 value="0.00" title="Opcional - Informe o percentual sobre o capital votante referente ao controlador em questão" size="7">
    </td>    
  </tr>
  <tr>
